      ...
      "targets": [
        {
          ...
          "direction": "backward",
          "editorMode": "code",
          "expr": "sum(count_over_time({job=\"$app\", env=\"api_access\"}[$__range]))",
          "queryType": "instant",
          "refId": "A"
        }
      ],
      ...
      "targets": [
        {
          ...
          "direction": "backward",
          "editorMode": "code",
          "expr": "avg(avg_over_time({job=\"$app\", env=\"api_access\"} | json | status = 200 | unwrap request_time [$__range]))",
          "legendFormat": "",
          "queryType": "instant",
          "refId": "A"
        }
      ],
      "title": "Average Response Time (200)",
      "type": "stat"
    },
    {
      "datasource": {
      ...
      "targets": [
        {
          "direction": "backward",
          "editorMode": "code",
          "expr": "sum by (status) (count_over_time({job=\"$app\", env=\"api_access\"} | status != \"\" [$__range]))",
          "hide": false,
          "queryType": "instant",
          "refId": "A"
        }
      ],
      "title": "API Status Map",
      "type": "bargauge"
    },
    {
      "datasource": {
      ...
      "targets": [
        {
          ...
          "direction": "backward",
          "editorMode": "code",
          "expr": "{job=\"$app\", host=\"$log_type\", env=~\"$env\"} |= \"$search\" | logfmt",
          "hide": false,
          "legendFormat": "",
          "queryType": "range",
          "refId": "A"
